...
public class Page {
    ...
    public void refreshpage(){
        ...
        logger.info("Страница обновленна");
    }



    public boolean CheckCurrentUrl(String URL) {
        logger.info("Получен URl - " + driver.getCurrentUrl());
        wait.until(d -> d.getCurrentUrl().contains(URL));
        return true;
    }

    public void clickonElementbyText(String element){
        String xpath = String.format("//*[contains(text(),'%s')]", element);
